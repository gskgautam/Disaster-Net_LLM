...
DATA_DIR = 'MEDIC Dataset/'
OUTPUT_DIR = 'MEDIC Dataset/processed/'
IMG_SIZE = 224
CLASSES = ['earthquake', 'flood', 'fire', 'landslide', 'storm', 'tsunami', 'volcano']
SPLITS = {'train': 0.7, 'val': 0.2, 'test': 0.1}
LOG_FILE = 'MEDIC Dataset/preprocess_error.log'
...
def get_image_paths_and_labels(data_dir):
    ...
    for class_name in CLASSES:
        ...
        if not os.path.isdir(class_dir):
            log_warning(f"Missing class directory: {class_dir}")
            continue
