...
DATA_DIR = 'Delhi Urban Risk Dataset/'
OUTPUT_FILE = 'Delhi Urban Risk Dataset/processed/events.csv'
LOG_FILE = 'Delhi Urban Risk Dataset/preprocess_error.log'
REQUIRED_COLS = ['event', 'date', 'location']
...
def main():
    ...
    log_info('Delhi Urban Risk preprocessing complete.')
    print('Delhi Urban Risk preprocessing complete.')
